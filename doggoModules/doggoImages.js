var doggoImages = (function() {
    ...
    return {
        ...
        getDoggo : function () {
            ...
            GetDoggoPreference().then(ReturnDoggoURL).then(function(result){
                return result
            })
            
        },

        replaceAllImages : function() {
            ...
            var topURL = this.getDoggo()
            ReplaceImages(topURL)
            return
